...
type pageQueryQuery = { readonly allContentfulPage: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly title: string | null, readonly slug: string | null } }> }, readonly contentfulPage: { readonly id: string, readonly title: string | null, readonly slug: string | null, readonly heading: string | null, readonly subheading: string | null, readonly sections: ReadonlyArray<{ readonly id: string, readonly title: string | null, readonly slug: string | null, readonly type: string | null, readonly heading: string | null, readonly subheading: string | null, readonly components: ReadonlyArray<{ readonly id: string, readonly title: string | null, readonly slug: string | null, readonly label: string | null, readonly date: string | null, readonly heading: string | null, readonly subheading: string | null, readonly richText: { readonly raw: string | null } | null, readonly image: { readonly id: string, readonly altText: string | null, readonly caption: string | null, readonly asset: { readonly id: string, readonly title: string | null, readonly description: string | null, readonly mimeType: string, readonly size: number | null, readonly url: string | null, readonly width: number | null, readonly height: number | null, readonly file: { readonly url: string | null, readonly fileName: string | null, readonly contentType: string | null, readonly details: { readonly size: number | null, readonly image: { readonly width: number | null, readonly height: number | null } | null } | null } | null } | null } | null, readonly links: ReadonlyArray<{ readonly id: string, readonly title: string | null, readonly label: string | null, readonly ref: { readonly id: string, readonly title: string | null, readonly slug: string | null } | null } | null> | null, readonly namedStrings: ReadonlyArray<{ readonly id: string, readonly name: string | null, readonly value: string | null } | null> | null } | null> | null } | null> | null } | null };
